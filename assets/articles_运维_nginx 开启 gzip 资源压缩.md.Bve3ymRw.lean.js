import{_ as s,c as a,a2 as p,o as i}from"./chunks/framework.BzAcaPI_.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/运维/nginx 开启 gzip 资源压缩.md","filePath":"articles/运维/nginx 开启 gzip 资源压缩.md"}'),t={name:"articles/运维/nginx 开启 gzip 资源压缩.md"};function e(l,n,c,o,g,r){return i(),a("div",null,n[0]||(n[0]=[p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>http {</span></span>
