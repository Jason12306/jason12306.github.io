import{_ as n,c as a,a2 as p,o as e}from"./chunks/framework.CcW9nX11.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/运维/nginx 配置 wss.md","filePath":"articles/运维/nginx 配置 wss.md","lastUpdated":1728456797000}'),l={name:"articles/运维/nginx 配置 wss.md"};function t(i,s,c,r,o,_){return e(),a("div",null,s[0]||(s[0]=[p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>server{</span></span>
