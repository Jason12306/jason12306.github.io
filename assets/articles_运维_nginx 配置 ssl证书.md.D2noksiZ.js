import{_ as n,c as a,o as e,ag as p}from"./chunks/framework.D_tDIJsW.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/运维/nginx 配置 ssl证书.md","filePath":"articles/运维/nginx 配置 ssl证书.md"}'),l={name:"articles/运维/nginx 配置 ssl证书.md"};function i(t,s,c,o,r,d){return e(),a("div",null,s[0]||(s[0]=[p(`<h3 id="一、-生成一个-ssl-证书" tabindex="-1">一、 生成一个 SSL 证书 <a class="header-anchor" href="#一、-生成一个-ssl-证书" aria-label="Permalink to &quot;一、 生成一个 SSL 证书&quot;">​</a></h3><p><code>openssl req -x509 -nodes -days 36500 -newkey rsa:2048 -keyout nginx.key -out nginx.crt</code> 字段含义</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Country ，单位所在国家，为两位数的国家缩写，如： CN 就是中国</span></span>
