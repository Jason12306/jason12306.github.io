import{_ as s,c as a,a2 as p,o as t}from"./chunks/framework.CcW9nX11.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/运维/nginx 开启 gzip 资源压缩.md","filePath":"articles/运维/nginx 开启 gzip 资源压缩.md","lastUpdated":1728456797000}'),i={name:"articles/运维/nginx 开启 gzip 资源压缩.md"};function e(l,n,c,o,g,r){return t(),a("div",null,n[0]||(n[0]=[p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>http {</span></span>
...
<span class="line"><span>    # ... </span></span>
<span class="line"><span>}</span></span></code></pre></div>`,1)]))}const m=s(i,[["render",e]]);export{d as __pageData,m as default};
